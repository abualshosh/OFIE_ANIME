...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.ashraf.ofieanime.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.ashraf.ofieanime.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.ashraf.ofieanime.domain.User::class.java.name)
            createCache(cm, com.ashraf.ofieanime.domain.Authority::class.java.name)
            createCache(cm, com.ashraf.ofieanime.domain.User::class.java.name + ".authorities")
            createCache(cm, com.ashraf.ofieanime.domain.PersistentToken::class.java.name)
            createCache(cm, com.ashraf.ofieanime.domain.User::class.java.name + ".persistentTokens")
