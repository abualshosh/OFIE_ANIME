...
import com.ashraf.ofieanime.config.ApplicationProperties
import com.ashraf.ofieanime.config.CRLFLogConverter
...
class OfieAnimeApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes OFIE_ANIME.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<OfieAnimeApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(OfieAnimeApp::class.java)
