  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ofieAnimeApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="ofieAnimeApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('ofieAnimeApp.tag.name')} id="tag-name" name="name" data-cy="name" type="text" />
              <ValidatedField id="tag-anime" name="anime" data-cy="anime" label={translate('ofieAnimeApp.tag.anime')} type="select">
                <option value="" key="0" />
                {anime
