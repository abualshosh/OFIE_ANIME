    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tagDetailsHeading">
          <Translate contentKey="ofieAnimeApp.tag.detail.title">Tag</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="ofieAnimeApp.tag.name">Name</Translate>
            </span>
          </dt>
          <dd>{tagEntity.name}</dd>
          <dt>
            <Translate contentKey="ofieAnimeApp.tag.anime">Anime</Translate>
          </dt>
          <dd>{tagEntity.anime ? tagEntity.anime.id : ''}</dd>
        </dl>
