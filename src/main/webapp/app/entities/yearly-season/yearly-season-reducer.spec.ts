...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_YEARLYSEASON_LIST actions', async () => {
    ...
    it('dispatches SEARCH_YEARLYSEASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_YEARLYSEASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_YEARLYSEASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_YEARLYSEASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_YEARLYSEASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_YEARLYSEASON actions', async () => {
      const expectedActions = [
        {
