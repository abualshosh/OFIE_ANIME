...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_URLLINK_LIST actions', async () => {
    ...
    it('dispatches SEARCH_URLLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_URLLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_URLLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_URLLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_URLLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_URLLINK actions', async () => {
      const expectedActions = [
        {
