...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIME_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ANIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ANIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIME actions', async () => {
      const expectedActions = [
        {
