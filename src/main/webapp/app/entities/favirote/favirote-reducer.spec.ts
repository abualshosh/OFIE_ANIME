...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVIROTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FAVIROTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FAVIROTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAVIROTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAVIROTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAVIROTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAVIROTE actions', async () => {
      const expectedActions = [
        {
